module TestService
  module Validator
    def self.check_test_card_authorized(test_card, current_user)
      ...
      if test_card&.status == 'submitted'
        return [false, 'Test card already have submitted']
      end
    ...
    def self.check_test_session_authorized(test_session, current_user)
      ...
      if test_session&.status == 'submitted'
        return [false, 'Test session already have submitted']
      end
